...
export default function CommentList(props) {
  ...
  if (!props.comments)
  {
    return  <div className="grid grid-cols-1 w-1354px bg-white pt-20px pb-20px pr-25px pl-40px rounded-25px drop-shadow-md place-items-center text-300px text-gray-500">
